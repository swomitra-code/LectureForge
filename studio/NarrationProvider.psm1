...
function Invoke-LFElevenLabs($Settings,[string]$Text,[string]$Output) {
    ...
    $payload=@{text=$Text;model_id=$Settings.model_id;voice_settings=@{stability=$Settings.stability;similarity_boost=$Settings.similarity_boost;style=$Settings.style;use_speaker_boost=$Settings.use_speaker_boost;speed=$Settings.speed}}
...
Export-ModuleMember -Function Protect-NarrationDiagnostic,Get-NarrationFailureDiagnostic,Invoke-LFElevenLabs
