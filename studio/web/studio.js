...
$('review').onclick=()=>action(async()=>{await save();await loadNarration();await request('/api/thumbnails?id='+project.id,{});$('review-panel').hidden=false;$('selection-summary').hidden=true;renderReview();});
